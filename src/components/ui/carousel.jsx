...
const Carousel = React.forwardRef(function Carousel(
  ...
  const onSelect = React.useCallback((_api) => {
    if (!_api) return;
...
const CarouselPrevious = React.forwardRef(function CarouselPrevious(
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "absolute h-8 w-8 rounded-full border border-neutral-200 bg-white text-neutral-900 shadow-sm hover:bg-neutral-50 disabled:opacity-40",
